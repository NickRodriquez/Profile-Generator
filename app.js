...
async function generateHTML() {
    let Template = {
        ...
        Manager: await getHTMLModule("./templates/employee.html"),
        Engineer: await getHTMLModule("./templates/employee.html"),
        Intern: await getHTMLModule("./templates/employee.html")
    }
    ...
    for (let employee of employees) {
        ...
        switch (employee.constructor.name) {
            case "Manager":
                html = html.replace(/{% Extra %}/gi, employee.officeNumber);
                break;
            case "Engineer":
                html = html.replace(/{% Extra %}/gi, employee.github);
                break;
            case "Intern":
                html = html.replace(/{% Extra %}/gi, employee.school);
                break;
        }
        employeesHTML += html;
    }
